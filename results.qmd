...
ggplot(comp_read_counts, aes(x = complication, y = Yes, fill = readmission)) +
  ...
  theme_gray(16)+
  theme(axis.text.x = element_text(angle = 45, hjust = 1),plot.margin = unit(c(0, 0, 0, 3), "cm"))
```
...
ggplot(cabg_comp_read_counts) +
  ...
  scale_fill_manual(values = custom) +
  facet_wrap(~Complication) +
  labs(title = "Mosaic Plot of Surgical Procedure and Readmission for Each Complication", x="Surgical Procedure") +
  theme_grey(16)+
  theme(axis.text.x = element_text(angle = 45, hjust=1), aspect.ratio = 1, axis.ticks.x=element_blank(), line = element_blank(), axis.ticks.y=element_blank())
...
ggplot(pay_comp_read_counts) +
  ...
  scale_fill_manual(values = custom) +
  facet_wrap(~Complication) +
  labs(title = "Mosaic Plot of Insurance Type and Readmission for Each Complication", x="Insurance Type") +
  theme_grey(16)+
  theme(axis.text.x = element_text(angle = 45, hjust=1), aspect.ratio = 1, axis.ticks.x=element_blank(), line = element_blank(), axis.ticks.y=element_blank())
